Given the dataset (https://d396qusza40orc.cloudfront.net/rprog%2Fdata%2Fspecdata.zip) in 332 separate csv files , which contain US pollution data, create the following:
Part 1
